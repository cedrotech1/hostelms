            ...
            <div class="mb-4">
              ...
              <div class="alert alert-info">
                ...
                <ol class="mb-0">
                  ...
                  <li>You can only upload students for your assigned campus</li>
                </ol>
              </div>
            </div>
                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Unique student ID (e.g., 221017990)</td>
                    </tr>
                    <tr>
                      <td>Campus*</td>
                      <td>Must match your assigned campus exactly</td>
                    </tr>
                    <tr>
                      <td>College*</td>
...
<script>
  ...
  function downloadTemplate() {
      ...
      // Example data
      const exampleData = [
          ['221017999', 'huye', 'College of Science', 'John', 'Doe', 'School of Engineering', 'Computer Science', '1', 'john.doe@example.com', 'Male', '1234567890123456', '781234567'],
          ['221078789', 'huye', 'College of Science', 'Jane', 'Smith', 'School of Engineering', 'Information Technology', '2', 'jane.smith@example.com', 'Female', '1234567890123457', '0781234568']
      ];
