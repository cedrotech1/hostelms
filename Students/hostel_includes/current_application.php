                            ...
                            <?php if ($current_application['slep']): ?>
                                <div class="current-receipt mb-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="mb-3">
                                                <i class="bi bi-file-earmark-text me-2"></i>Current Receipt
                                            </h6>
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    <p class="mb-1">
                                                        ...
                                                        Receipt File: 
                                                        <strong><?php echo htmlspecialchars($current_application['slep']); ?></strong>
                                                    </p>
                                                </div>
                                                <div class="col-md-4 text-end">
                                                    ...
                                                    <!-- <button id="edit-receipt-btn" class="btn btn-warning btn-sm">
                            ...
                            <form action="upload_receipt.php" method="POST" enctype="multipart/form-data" class="mt-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="receipt_number" class="form-label"><i class="bi bi-receipt me-2"></i>Receipt Number</label>
                                        <input type="text" class="form-control" id="receipt_number" name="receipt_number" 
                                            placeholder="Enter receipt number" required 
                                            value="<?php echo isset($current_application['ReceptNumber']) ? htmlspecialchars($current_application['ReceptNumber']) : ''; ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="date_of_payment" class="form-label"><i class="bi bi-calendar me-2"></i>Date of Payment</label>
                                ...
                                <div class="mb-3">
                                    <label for="receipt" class="form-label"><i class="bi bi-upload me-2"></i>Upload Receipt File</label>
                                    <!-- Only PDF allowed -->
                                    <input type="file" class="form-control" id="receipt" name="receipt" accept="application/pdf" required>
                                    <small class="text-muted">
                                        <i class="bi bi-info-circle me-1"></i>Accepted format: PDF only (Max size: 2MB)
                                    </small>

                                    <!-- PDF preview (hidden until file chosen) -->
                                    <div id="receipt-preview-container" class="mt-3" style="display:none;">
                                        <label class="form-label">Preview:</label>
                                        <iframe id="receipt-preview" style="width:100%; height:400px; border:1px solid #ccc; border-radius:6px;" frameborder="0"></iframe>
                                    </div>
                                </div>
